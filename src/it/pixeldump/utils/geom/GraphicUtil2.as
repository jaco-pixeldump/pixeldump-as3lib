package it.pixeldump.utils.geom {
	...
	import it.pixeldump.utils.ColorUtil2;
     ...
     */
    public class GraphicUtil2 extends mx.utils.GraphicsUtil {
         ...
         */
        public static function drawCircle(g:Graphics, center:Point, radius:Number, dashed:Boolean = false, dashLength:Number = 10, segments:int = 360):void {
            if (dashed) {
         ...
         */
        public static function drawArc(g:Graphics, center:Point, radius:Number, startAngle:Number = 0, endAngle:Number = 90, dashed:Boolean = false, dashLength:Number = 10, segments:int = 360):void {
            if ((startAngle < 0) || (startAngle > 360) || (endAngle < 0) || (endAngle > 360) || (startAngle == endAngle)) {
         ...
         * @param dashLength the length of the dash (only applies if dashed is true)
         */
        public static function drawLine(g:Graphics, start:Point, end:Point, dashed:Boolean = false, dashLength:Number = 10):void {
         ...
         */
        public static function drawQuadCurve(g:Graphics, start:Point, cp:Point, end:Point, dashed:Boolean = false, dashLength:Number = 10, segments:Number = 200):void {
            g.moveTo(start.x, start.y);
         ...
         */
        public static function drawCubicCurve(g:Graphics, start:Point, cp1:Point, cp2:Point, end:Point, dashed:Boolean = false, dashLength:Number = 10, segments:Number = 200):void {
         ...
         */
        public static function drawOutsetBorder(g:Graphics, w:Number, h:Number, color:uint = 0x0, thickness:Number = 1, alpha:Number = 1):void {
         ...
         * The highlight and shadow colors are derived from the given color.
         */
        public static function drawInsetBorder(g:Graphics, w:Number, h:Number, color:uint = 0x0, thickness:Number = 1, alpha:Number = 1):void {
         ...
         */
        public static function createDottedLineBitmap(lineColor:uint, lineAlpha:Number, lineThickness:Number, vertical:Boolean = true):BitmapData {
            var w:Number = (vertical ? lineThickness : 2 * lineThickness);
            var h:Number = (vertical ? 2 * lineThickness : lineThickness);
            var color32:uint = ColorUtil2.combineColorAndAlpha(lineColor, lineAlpha);
         ...
         */
        public static function beginFill(g:Graphics, w:Number, h:Number, colors:Array, alphas:Array = null, gradientType:String = "linear", gradientRotation:Number = Math.PI / 2, spreadMethod:String = "pad"):void {
